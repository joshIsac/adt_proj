...
<head>
    ...
    background-image:url(images/clothedonate1.jpg);
...
<body>
    ...
    <p align="center"><u>CLOTHE DONATION</u></p>
...
$sql="INSERT INTO donate(name,email,address,phone,donatingitem,quantity)VALUES('$name','$email','$address','$phone','$food','$quantity')";
$result=mysqli_query($conn,$sql);
    if($result){
       echo"<script>alert('Things shared successfully.Wait for admin message')</script>";
    } 
